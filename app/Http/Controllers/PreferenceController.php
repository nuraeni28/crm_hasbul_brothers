...
class PreferenceController extends Controller
{
    ...
    public function schedulerAdd(Request $request)
    {
        ...
        $request->validate([
            'scheduleStatus' => 'required|integer',
            'eventTimeStart' => 'required|date',
            'eventTimeEnd' => 'required|date',
            'eventTitle' => 'required|string|max:200',
            'eventLocation' => 'required|string|max:100',
            'eventDetail' => 'required|string|max:500',
            'speakerId' => 'required|integer',
        ]);

        // Buat instance baru dari model PreferenceSchedule
...
public function packageDelete(Request $request)
    ...
    if (!$checkToken) {
        ...
        $deleted = DB::table('preference_package')->where('id', $request->packageId)->delete();
